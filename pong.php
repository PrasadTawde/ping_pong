...
<body>
  ...
  <script>
    ...
    function gameOver(playerWon) {
      ...
      if(playerWon) {
        ajax('updateData.php', {score: playerOneScore}, function(response) {     
        //console.log(response) will show the AJAX response in console
        });
        gameMessage.textContent = 'You won!';
        againBtn.textContent = 'Play again';
      } else {
        gameMessage.textContent = 'Oh ! you lost.';
